...
class Post(models.Model):
    ...
    evenementiel = models.BooleanField(default=False, blank=True)#Les deux variables sont ici non requises pour un POST.
...
#On choisira d'ordonner l'ensemble des POSTs en fonction de leur date de publication. Plus un POST est ancien, plus il faudra descendre sur la page pour le voir.
    class Meta:
